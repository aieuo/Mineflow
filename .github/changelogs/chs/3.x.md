...
- Added new actions
  - Set a player data
    - Stores personal player data in the player variable. Stores personal player data in the player variable. Stores personal player data in the player variable. To get the data from a player variable, you can use `<player variable name>.data.<data name>` variable. Example) `target.data.money` Example) `target.data.money` Example) `target.data.money`
