...
- Menambahkan tindakan baru
  - Atur data pemain
    - Menyimpan data pemain pribadi di dalam variabel pemain. To get the data from a player variable, you can use `<player variable name>.data.<data name>` variable. Example) `target.data.money`
