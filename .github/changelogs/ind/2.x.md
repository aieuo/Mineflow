This page was made by [@keenanyafiqy](https://github.com/keenanyafiqy). Some of them are contributed by [@aieuo](https://github.com/aieuo)
# 2.0.0
...
- Menambahkan tindakan baru.
    ...
    - Buat AABB
    - Buat AABB dari variabel posisi
    - Jika tidak
