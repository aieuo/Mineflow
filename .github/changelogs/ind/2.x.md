This page was made by [@keenanyafiqy](https://github.com/keenanyafiqy)
# 2.0.0
...
- Ditambahkan Bahasa Indonesia oleh @keenanyafiqy
...
- Menambahkan tindakan baru.
    - Dapatkan entitas di area tertentu
    - Dapatkan pemain di area tertentu
    - Buat sebuah AABB
    - Buat sebuah AABB dari variabel posisi
    - Jika tidak
    - Dapatkan entitas terdekat ke posisi tertentu
    - Dapatkan tempat tinggal terdekat ke posisi tertentu
    - Dapatkan pemain terdekat ke posisi tertentu
