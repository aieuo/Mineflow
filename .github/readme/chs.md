...
**To show them all, please run `mineflow permission <your name> 2` from the console.**
...
The level you give can only be used below your level.
You can give a maximum level from the console.
