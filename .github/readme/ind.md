...
Untuk mengubah izin, jalankan `/mineflow permission <add|remove|list> <name> <permission>`.
Hanya pemain yang memiliki izin `izin` yang dapat mengubah izin pemain lain.
Kamu dapat memberikan semua izin dari konsol.
