...
**Para mostrarlas todas, por favor ejecuta `mineflow permission add <your name> all` desde la consola.**
...
Para cambiar el permiso, ejecute `/mineflow permission <add|remove|list> <name> <permission>`.
