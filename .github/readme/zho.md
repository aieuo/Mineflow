...
**Some actions are hidden by default to prevent abuse. To show them all, please run `mineflow permission add <your name> all` from the console.** To show them all, please run `mineflow permission add <your name> all` from the console.</strong>
