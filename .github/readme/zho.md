...
**Some of the actions are hidden by default to prevent abuse. \* Some of the actions are hidden by default to prevent abuse. To show them all, please run `mineflow permission <your name> 2` from the console.</p>
