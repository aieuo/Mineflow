...
class EventManager {
    ...
    public function addDefaultTriggers(): void {
        ...
        $this->addTrigger(new FurnaceSmeltEventTrigger(), false);
        $this->addTrigger(new LevelLoadEventTrigger(), false);
        $this->addTrigger(new PlayerBedEnterEventTrigger(), false);
        $this->addTrigger(new PlayerBedLeaveEventTrigger(), false);
        $this->addTrigger(new PlayerBlockPickEventTrigger(), false);
        $this->addTrigger(new PlayerBucketEmptyEventTrigger(), false);
        $this->addTrigger(new PlayerBucketEventTrigger(), false);
        $this->addTrigger(new PlayerBucketFillEventTrigger(), false);
        ...
        $this->addTrigger(new PlayerEntityInteractEventTrigger(), true);
        $this->addTrigger(new PlayerEntityPickEventTrigger(), false);
        ...
        $this->addTrigger(new PlayerItemHeldEventTrigger(), true);
        $this->addTrigger(new PlayerItemUseEventTrigger(), true);
        ...
        $this->addTrigger(new PlayerRespawnEventTrigger(), true);
