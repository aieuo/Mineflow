...
class PlayerBucketEmptyEventTrigger extends EventTrigger {
    public function __construct() {
        parent::__construct("PlayerBucketEmptyEvent", PlayerBucketEmptyEvent::class);
    }

    public function getVariables(mixed $event): array {
        /** @var PlayerBucketEmptyEvent $event */
