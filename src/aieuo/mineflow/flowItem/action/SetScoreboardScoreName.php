...
class SetScoreboardScoreName extends Action implements ScoreboardFlowItem {
    use ScoreboardFlowItemTrait;

    protected $id = self::SET_SCOREBOARD_SCORE_NAME;

    protected $name = "action.setScoreName.name";
    protected $detail = "action.setScoreName.detail";
    ...
    public function getEditForm(array $default = [], array $errors = []): Form {
        return (new CustomForm($this->getName()))
            ->setContents([
                ...
                new ExampleInput("@action.setScore.form.score", "100", $default[3] ?? $this->getScore(), true),
                new CancelToggle()
            ])->addErrors($errors);
    }
