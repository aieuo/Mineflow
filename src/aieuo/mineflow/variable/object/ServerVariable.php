...
class ServerVariable extends ObjectVariable {
    ...
    public static function registerProperties(string $class = self::class): void {
        ...
        self::registerProperty(
            $class, "date", new VariableProperty(
                new DummyVariable(MapVariable::class),
                fn(Server $server) => new MapVariable([
        ...
        self::registerProperty(
            $class, "default_world", new VariableProperty(
        ...
        self::registerProperty(
            $class, "worlds", new VariableProperty(
        ...
        self::registerProperty(
            $class, "players", new VariableProperty(
        ...
        self::registerProperty(
            $class, "entities", new VariableProperty(
        ...
        self::registerProperty(
            $class, "livings", new VariableProperty(
                new DummyVariable(ListVariable::class, EntityVariable::getTypeName()),
                function (Server $server) {
                    $entities = [];
                    foreach ($server->getWorldManager()->getWorlds() as $world) {
        ...
        self::registerProperty(
            $class, "ops", new VariableProperty(
        ...
        self::registerProperty(
            $class, "bans", new VariableProperty(
                new DummyVariable(ListVariable::class, StringVariable::getTypeName()),
        ...
        self::registerProperty(
            $class, "ip_bans", new VariableProperty(
                new DummyVariable(ListVariable::class, StringVariable::getTypeName()),
        ...
        self::registerProperty(
            $class, "whitelist", new VariableProperty(
                new DummyVariable(ListVariable::class, StringVariable::getTypeName()),
